...
$ podman unshare --rootless-netns /usr/sbin/iptables-save

$ podman unshare --rootless-netns /usr/sbin/ip6tables-save

$ podman unshare --rootless-netns /sbin/nft list tables
table inet netavark

$ podman unshare --rootless-netns /sbin/nft list table inet netavark
table inet netavark {
        chain INPUT {
